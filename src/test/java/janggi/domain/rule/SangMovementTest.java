...
class SangMovementTest {
    ...
    private static final SangMovement MOVEMENT = SangMovement.getInstance();
    ...
    class CalculateRouteTest {
        ...
        static Stream<Arguments> provideReachableDestinationAndPathCoordination() {
            return Stream.of(
                    Arguments.of(
                            new Location(-3, -2), // 상 + 좌측 대각선 전진 2회
                            List.of(
                                    new Location(-1, 0),
                                    new Location(-2, -1),
                                    new Location(-3, -2)
                    ...
                    Arguments.of(
                            new Location(-3, 2), // 상 + 우측 대각선 전진 2회
                            List.of(
                                    new Location(-1, 0),
                                    new Location(-2, 1),
                                    new Location(-3, 2)
                    ...
                    Arguments.of(
                            new Location(3, -2), // 하 + 좌측 대각선 후진 2회
                            List.of(
                                    new Location(1, 0),
                                    new Location(2, -1),
                                    new Location(3, -2)
                    ...
                    Arguments.of(
                            new Location(3, 2), // 하 + 우측 대각선 후진 2회
                            List.of(
                                    new Location(1, 0),
                                    new Location(2, 1),
                                    new Location(3, 2)
                    ...
                    Arguments.of(
                            new Location(-2, -3), // 좌 + 좌측 대각선 전진 2회
                            List.of(
                                    new Location(0, -1),
                                    new Location(-1, -2),
                                    new Location(-2, -3)
                    ...
                    Arguments.of(
                            new Location(2, -3), // 좌 + 좌측 대각선 후진 2회
                            List.of(
                                    new Location(0, -1),
                                    new Location(1, -2),
                                    new Location(2, -3)
                    ...
                    Arguments.of(
                            new Location(-2, 3), // 우 + 우측 대각선 전진 2회
                            List.of(
                                    new Location(0, 1),
                                    new Location(-1, 2),
                                    new Location(-2, 3)
                    ...
                    Arguments.of(
                            new Location(2, 3), // 우 + 우측 대각선 후진 2회
                            List.of(
                                    new Location(0, 1),
                                    new Location(1, 2),
                                    new Location(2, 3)
