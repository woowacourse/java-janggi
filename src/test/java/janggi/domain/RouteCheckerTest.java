...
public class RouteCheckerTest {
    ...
    void 초나라_졸_장애물_없을때_이동_성공() {
        ...
        //when
        List<Position> zolRoutesPositions = routeChecker.findAvailablePositions(board, position);
    ...
    void 마_장애물_없을때_8방향_이동_성공() {
        ...
        //when
        List<Position> maRoutesPositions = routeChecker.findAvailablePositions(board, position);
    ...
    void 상_장애물_없을때_8방향_이동_성공() {
        ...
        //when
        List<Position> sangRoutesPositions = routeChecker.findAvailablePositions(board, position);
    ...
    void 차_장애물_없을때_직선_끝까지_이동_성공() {
        ...
        //when
        List<Position> chaRoutesPositions = routeChecker.findAvailablePositions(board, position);
