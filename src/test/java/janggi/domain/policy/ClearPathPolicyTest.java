...
class ClearPathPolicyTest {
    private boolean checkMovable(List<Position> path, BaseBoard board) {
    ...
    void 기물은_모든_경로와_도착지에_모두_비어있는_경우_움직일_수_있다() {
        ...
        BaseBoard board = createBoardInterface(isEmpty, List.of());
    ...
    void 기물은_모든_경로가_모두_비어있고_도착지에_아군이_있는_경우_움직일_수_없다() {
        ...
        BaseBoard board = createBoardInterface(isEmpty, isAlly);
