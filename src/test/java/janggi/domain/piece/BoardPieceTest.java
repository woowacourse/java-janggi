...
class BoardPieceTest {
    ...
    void moveTest() {
        // given
        BoardPiece boardPiece = new BoardPiece(new HanPoint(1, 1), new Soldier(), Dynasty.HAN);
        ...
        assertThat(boardPiece)
                .isEqualTo(new BoardPiece(new HanPoint(2, 1), new Soldier(), Dynasty.HAN));
    }
    ...
    void moveFailTest_WhenExistSameDynastyPiece() {
        // given
        BoardPiece samePiece = new BoardPiece(new HanPoint(2, 1), new Soldier(), Dynasty.HAN);
        BoardPiece boardPiece = new BoardPiece(new HanPoint(1, 1), new Soldier(), Dynasty.HAN);
        JanggiBoard janggiBoard = new JanggiBoard(Set.of(
    ...
    void isSamePosition(int x1, int y1, int x2, int y2, boolean expected) {
        //given
        BoardPiece boardPiece = new BoardPiece(new HanPoint(x1, y1), new Soldier(), Dynasty.HAN);
