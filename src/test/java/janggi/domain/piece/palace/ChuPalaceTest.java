...
class ChuPalaceTest {
    ...
    void cannotMove_whenOutPalacePoints() {
        //given
        ChuPalace chuPalace = new ChuPalace();

        //when
        boolean result = chuPalace.canMoveInPalace(Fixtures.ONE_ONE, Fixtures.ONE_TWO, Direction.RIGHT);
    ...
    void cannotMove_whenCannotMoveDiagonal() {
        ...
        //when
        boolean result = chuPalace.canMoveInPalace(Fixtures.NINE_FOUR, Fixtures.EIGHT_FIVE,
    ...
    void canMove_whenCanMoveDiagonal() {
        ...
        //when
        boolean result = chuPalace.canMoveInPalace(Fixtures.TEN_FOUR, Fixtures.NINE_FIVE, Direction.UP_RIGHT_DIAGONAL);
    ...
    void canMoveInPalace() {
        ...
        //when
        boolean result = chuPalace.canMoveInPalace(Fixtures.NINE_FIVE, Fixtures.NINE_FOUR, Direction.LEFT);
    ...
    void isInPalace(Point point, boolean expected) {
        ...
        //when
        boolean result = chuPalace.isInPalace(point);
    ...
    private static Stream<Arguments> provideIsInPalaceData() {
        return Stream.of(
                Arguments.of(Fixtures.NINE_FOUR, true),
                Arguments.of(Fixtures.EIGHT_FIVE, true),
