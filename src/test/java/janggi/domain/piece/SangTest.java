...
class SangTest extends BaseTest {

    @ParameterizedTest
    @MethodSource("provideValidPositions")
    void 상은_전진_대각선_대각선으로_움직인다(final Position newPosition) {
        // given
        final Piece piece = new Piece(PieceType.SANG, POSITION_5_5);
    ...
    public static Stream<Arguments> provideValidPositions() {
        return Stream.of(
                ...
                Arguments.of(POSITION_8_7),
                Arguments.of(POSITION_8_3)
        );
    }
    ...
    public static Stream<Arguments> provideInvalidPositions() {
        return Stream.of(
                ...
                Arguments.of(POSITION_8_4),
                Arguments.of(POSITION_8_5),
                Arguments.of(POSITION_8_6),
                Arguments.of(POSITION_8_8)
        );
    }
}
