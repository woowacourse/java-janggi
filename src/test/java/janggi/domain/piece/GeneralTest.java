...
public class GeneralTest {
    ...
    class CalculateMovablePositions {
        ...
        void test1() {
            ...
            List<Position> actual = general.calculateMovablePositions(Position.valueOf(6, 4), boardMediator);
        ...
        void test3() {
            ...
            BoardMediator boardMediator = new Board(positionPieceMap);
            List<Position> actual = general.calculateMovablePositions(Position.valueOf(1, 1), boardMediator);
