...
public class GeneralTest {
    ...
    class CalculateMovablePositions {
        ...
        void test1() {
            positionPieceMap.put(Position.valueOf(1, 4), general);
            ...
            List<Position> actual = general.calculateMovablePositions(Position.valueOf(1, 4), boardMediator);
        ...
        void test2() {
            positionPieceMap.put(Position.valueOf(2, 5), general);
            ...
            BoardMediator boardMediator = new Board(positionPieceMap);
            List<Position> actual = general.calculateMovablePositions(Position.valueOf(2, 5), boardMediator);
        ...
        @DisplayName("장은 모든 방향 중 한 칸을 가서 기물을 잡을 수 있다.")
        void test3() {
            positionPieceMap.put(Position.valueOf(3, 5), general);
            ...
            BoardMediator boardMediator = new Board(positionPieceMap);
            List<Position> actual = general.calculateMovablePositions(Position.valueOf(3, 5), boardMediator);
        ...
        void test4() {
            positionPieceMap.put(Position.valueOf(1, 5), general);
            ...
            BoardMediator boardMediator = new Board(positionPieceMap);
            List<Position> actual = general.calculateMovablePositions(Position.valueOf(1, 5), boardMediator);

            assertThat(actual).hasSameElementsAs(expected);
        }

        @Test
        @DisplayName("장은 궁성영역 안에서만 이동할 수 있다.")
        void test5() {
            positionPieceMap.put(Position.valueOf(2, 5), general);
            List<Position> expected = List.of(
                    Position.valueOf(1, 4),
