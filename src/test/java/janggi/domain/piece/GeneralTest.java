...
class GeneralTest {
    ...
    void canMove(PiecesOnPath piecesOnPath, boolean expected) {
        ...
        //when
        boolean actual = general.canMove(piecesOnPath);
