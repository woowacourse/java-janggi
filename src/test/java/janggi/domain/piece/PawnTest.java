...
public class PawnTest {
    ...
    private static Stream<Arguments> 이동하고자_하는_위치에_적_기물이_있으면_이동할_수_있다_테스트_케이스() {
        return Stream.of(
            Arguments.of(DEFAULT_ALLY_PAWN, List.of(createEnemyPawn(4, 5)), 4, 5),
            Arguments.of(DEFAULT_ALLY_PAWN, List.of(createEnemyPawn(6, 5)), 6, 5),
            Arguments.of(DEFAULT_ALLY_PAWN, List.of(createEnemyPawn(5, 6)), 5, 6),
            Arguments.of(createEnemyPawn(5, 5), List.of(createAllyPawn(4, 5)), 4, 5),
            Arguments.of(createEnemyPawn(5, 5), List.of(createAllyPawn(6, 5)), 6, 5),
            Arguments.of(createEnemyPawn(5, 5), List.of(createAllyPawn(5, 4)), 5, 4)
        );
    }

    public static Stream<Arguments> 이동하고자_하는_위치에_아군_기물이_있으면_이동할_수_없다_테스트_케이스() {
        return Stream.of(
            Arguments.of(DEFAULT_ALLY_PAWN, List.of(createAllyPawn(4, 5)), 4, 5),
            Arguments.of(DEFAULT_ALLY_PAWN, List.of(createAllyPawn(6, 5)), 6, 5),
            Arguments.of(DEFAULT_ALLY_PAWN, List.of(createAllyPawn(5, 6)), 5, 6),
            Arguments.of(createEnemyPawn(5, 5), List.of(createEnemyPawn(4, 5)), 4, 5),
            Arguments.of(createEnemyPawn(5, 5), List.of(createEnemyPawn(6, 5)), 6, 5),
            Arguments.of(createEnemyPawn(5, 5), List.of(createEnemyPawn(5, 4)), 5, 4)
        );
    }
