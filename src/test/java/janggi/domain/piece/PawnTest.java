...
public class PawnTest {
    ...
    private static Pawn DEFAULT_ALLY_PAWN = new Pawn(ALLY_SIDE, DEFAULT_POSITION);

    private static Pawn createAllyPawn(int x, int y) {
        return new Pawn(ALLY_SIDE, new Position(x, y));
    }

    private static Pawn createEnemyPawn(int x, int y) {
        return new Pawn(ENEMY_SIDE, new Position(x, y));
    }
