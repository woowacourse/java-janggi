...
class ByeongTest {
    ...
    void 병은_전진_대각선으로_움직인다(final Position newPosition) {
        // given
        final Byeong byeong = new Byeong(POSITION_5_5);

        // expected
        assertThatCode(() -> byeong.move(newPosition, List.of(), List.of()))
    ...
    void 그_외의_위치로는_이동할_수_없다(final Position invalidPosition) {
        ...
        // expected
        assertThatThrownBy(() -> byeong.move(invalidPosition, List.of(), List.of()))
    ...
    void 중간에_기물로_가로막힌다(final Position newPosition) {
        ...
        // expected
        assertThatThrownBy(() -> byeong.move(newPosition, List.of(
                new Ma(POSITION_4_5),
                new Ma(POSITION_6_5),
                new Ma(POSITION_5_4),
                new Ma(POSITION_5_6)
    ...
    void 마지막에_적_기물이_있으면_먹는다(final Position newPosition) {
        ...
        // expected
        assertThatCode(() -> byeong.move(newPosition, List.of(), List.of(new Ma(newPosition))))
                .doesNotThrowAnyException();
    }
