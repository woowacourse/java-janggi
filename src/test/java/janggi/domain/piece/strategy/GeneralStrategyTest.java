...
class GeneralStrategyTest {
    ...
    private static Stream<Arguments> successMovePositions() {
        return Stream.of(
                Arguments.of(Camp.CHO, new Position(0, 3), new Position(0, 4)),
                Arguments.of(Camp.CHO, new Position(2, 5), new Position(2, 4)),

                Arguments.of(Camp.CHO, new Position(1, 4), new Position(1, 5)),
                Arguments.of(Camp.CHO, new Position(1, 4), new Position(1, 3)),
                Arguments.of(Camp.CHO, new Position(1, 4), new Position(0, 4)),
                Arguments.of(Camp.CHO, new Position(1, 4), new Position(2, 4)),
    ...
    void 직선_방향으로_1칸만_이동한다(Camp camp, Position source, Position destination) {
        assertThatNoException().isThrownBy(() ->
                moveStrategy.validate(source, destination, camp, null, PieceStrategy.GENERAL));
    }
    ...
    void 직선_방향으로_1칸만_이동하지_않으면_예외가_발생한다(Camp camp, Position source, Position destination) {
        assertThatThrownBy(() -> moveStrategy.validate(source, destination, camp, null, PieceStrategy.GENERAL))
