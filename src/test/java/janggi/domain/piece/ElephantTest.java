...
public class ElephantTest {
    ...
    void 경로에_존재하는_기물_중_빈_기물이_아닌_기물이_있으면_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> elephant.canMove(pieceOnPath, new EmptyPiece()))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void 이동할_위치에_같은_팀이_있으면_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> elephant.canMove(pieceOnPath, new Soldier(Team.HAN)))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void 이동_가능_확인_성공_테스트() {
        ...
        boolean result = elephant.canMove(pieceOnPath, new Chariot(Team.CHO));
