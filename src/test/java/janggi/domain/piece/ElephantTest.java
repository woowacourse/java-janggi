    ...
    private static Stream<Arguments> provideNormalMove() {
        return Stream.of(
                Arguments.of("북쪽 방향 정상 이동 (북->북동->북동)",
                        new Position(0, 0), new Position(3, 2), new FakeBoard()),
                ...
                Arguments.of("남쪽 방향 정상 이동 (남 -> 남서 -> 남서)",
                        new Position(9, 4), new Position(6, 2), new FakeBoard()),

                Arguments.of("남쪽 방향 정상 이동 (남 -> 남동 -> 남동)",
                        new Position(7, 3), new Position(4, 5), new FakeBoard()),

                Arguments.of("동쪽 방향 정상 이동 (동 -> 북동 -> 북동)",
                        new Position(0, 0), new Position(2, 3), new FakeBoard()),

                Arguments.of("동쪽 방향 정상 이동 (동 -> 남동 -> 남동)",
                        new Position(4, 4), new Position(2, 7), new FakeBoard()),

                Arguments.of("서쪽 방향 정상 이동 (서 -> 북서 -> 북서)",
                        new Position(0, 8), new Position(2, 5), new FakeBoard()),
    ...
    private static Stream<Arguments> provideInvalidMove() {
        return Stream.of(
                ...
                Arguments.of("상의 이동 패턴(직선1+대각2)이 아닌 경우",
                        new Position(0, 0), new Position(3, 3), new FakeBoard())
        );
    }
