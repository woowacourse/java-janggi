...
public class GungTest {
    ...
    class CalculateRouteTest {
        ...
        @ParameterizedTest
        @DisplayName("궁은 궁성 중앙에 있는 경우 궁성 내 모든 좌표로 이동할 수 있다.")
        ...
        @Test
        @DisplayName("궁은 궁성 안에서 대각선 길이 있는 경우 대각선으로 이동할 수 있다.")
        ...
        @ParameterizedTest
        @DisplayName("궁이 이동할 수 없는 위치를 파라미터로 받으면 예외가 발생한다.")
        ...
        @Test
        @DisplayName("궁이 궁성을 벗어나는 위치를 파라미터로 받으면 예외가 발생한다.")
