...
class CannonMovementStrategyTest {
    ...
    private static Piece createCannon(Side side, int x, int y) {
        return new Piece(PieceType.CANNON, new CannonMovementStrategy(), side, x, y);
    }
    ...
    private static Stream<Arguments> 이동하고자_하는_위치_내에_두_가지_이상의_기물이_있다면_이동할_수_없다_테스트_케이스() {
        return Stream.of(
            Arguments.of(
                createPieces(new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.CHO, 5, 7),
                    new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.HAN, 5, 8)),
                ALLY_SIDE,
                new Position(5, 5),
                new Position(5, 9)
            ),
            Arguments.of(
                createPieces(new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.CHO, 5, 3),
                    new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.HAN, 5, 1)),
                ALLY_SIDE,
                new Position(5, 5),
                new Position(5, 0)
            ),
            Arguments.of(
                createPieces(new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.CHO, 3, 5),
                    new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.HAN, 1, 5)),
                ALLY_SIDE,
                new Position(5, 5),
                new Position(0, 5)
            ),
            Arguments.of(
                createPieces(new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.CHO, 6, 5),
                    new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.HAN, 7, 5)),
                ALLY_SIDE,
                new Position(5, 5),
                new Position(8, 5)
            )
    ...
    private static Stream<Arguments> 이동하고자_하는_위치_내에_Canon_이_아닌_한_가지_기물이_있다면_이동할_수_있다_테스트_케이스() {
        return Stream.of(
            Arguments.of(
                createPieces(new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.HAN, 7, 5)),
                ALLY_SIDE,
                new Position(5, 5),
                new Position(8, 5)
            ),
            Arguments.of(
                createPieces(new Piece(PieceType.ROOK, new RookMovementStrategy(), Side.HAN, 3, 3)),
                ALLY_SIDE,
                new Position(2, 3),
                new Position(4, 3)
            )
    ...
    private static Stream<Arguments> 이동하고자_하는_위치_내에_Canon_인_한_가지_기물이_있다면_이동할_수_없다_테스트_케이스() {
        return Stream.of(
            Arguments.of(
                createPieces(new Piece(PieceType.CANNON, new RookMovementStrategy(), Side.HAN, 7, 5)),
                ALLY_SIDE,
                new Position(5, 5),
                new Position(8, 5)
            ),
            Arguments.of(
                createPieces(new Piece(PieceType.CANNON, new RookMovementStrategy(), Side.HAN, 3, 3)),
                ALLY_SIDE,
                new Position(2, 3),
                new Position(4, 3)
            )
    ...
    private static Stream<Arguments> 이동하고자_하는_위치에_아군_기물이_있다면_이동할_수_없다_테스트_케이스() {
        return Stream.of(
            Arguments.of(
                createPieces(new Piece(PieceType.CANNON, new RookMovementStrategy(), ALLY_SIDE, 7, 5)),
                ALLY_SIDE,
                new Position(5, 5),
                new Position(8, 5)
            ),
            Arguments.of(
                createPieces(new Piece(PieceType.CANNON, new RookMovementStrategy(), ENEMY_SIDE, 4, 5)),
                ENEMY_SIDE,
                new Position(5, 5),
                new Position(3, 5)
            )
