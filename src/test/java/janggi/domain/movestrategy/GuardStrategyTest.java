...
class GuardStrategyTest {
    ...
    private MoveStrategy guardStrategy;
    private Piece guard;
    ...
    @BeforeEach
    void setUp() {
        guardStrategy = new GuardStrategy(List.of(new StraightOneStepMoveRule()));
    ...
    void testCheckPathRuleWhenNoPieceInPath() {
        ...
        // when & then
        assertThat(guardStrategy.checkPathRule(emptyPieces)).isTrue();
    }
    ...
    void testNotCheckPathRuleWhenAnyPieceInPath() {
        ...
        // when & then
        assertThat(guardStrategy.checkPathRule(pathPieces)).isFalse();
        assertThat(guardStrategy.checkPathRule(pathPieces2)).isFalse();
    }
