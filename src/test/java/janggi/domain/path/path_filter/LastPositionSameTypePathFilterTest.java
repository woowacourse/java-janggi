...
class LastPositionSameTypePathFilterTest {

    @Test
    void 마지막에_동일한_종류의_기물로_끝나는_경로를_필터링한다() {
        // given
        ...
        sut.filter(
                ...
                paths,
                List.of(),
                List.of(new Piece(PieceType.졸, POSITION_3_8), new Piece(PieceType.병, POSITION_2_8))
        );
