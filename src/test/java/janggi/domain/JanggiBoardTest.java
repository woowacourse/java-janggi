...
public class JanggiBoardTest {
    ...
    void initializeBoard() {
        //given
        HanBoardSetUp hanBoardSetUp = HanBoardSetUp.INNER_ELEPHAN;
        ChuBoardSetUp chuBoardSetUp = ChuBoardSetUp.INNER_ELEPHAN;
        ...
        Map<Point, Piece> pieces = new HashMap<>() {
            {
                ...
                put(new Point(1, 2), new Knight(Dynasty.HAN));
                put(new Point(1, 3), new Elephant(Dynasty.HAN));
                ...
                put(new Point(10, 2), new Knight(Dynasty.CHU));
                put(new Point(10, 3), new Elephant(Dynasty.CHU));
                put(new Point(10, 4), new Guard(Dynasty.CHU));
                put(new Point(10, 6), new Guard(Dynasty.CHU));
                put(new Point(10, 7), new Elephant(Dynasty.CHU));
                put(new Point(10, 8), new Knight(Dynasty.CHU));
