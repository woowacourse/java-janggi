...
public class ChariotTest {
    ...
    void chariotUpTest() {
        //given
        Chariot chariot = new Chariot(Team.CHO, new Position(new Row(7), new Column(3)));
        ...
        //then
        assertThat(chariot.matchesPosition(new Position(new Row(3), new Column(3)))).isTrue();
    }
    ...
    void chariotDownTest() {
        ...
        chariot.move(arrivedPosition, positioningPiece);
        //then
        assertThat(chariot.matchesPosition(new Position(new Row(9), new Column(3)))).isTrue();
    }
    ...
    void chariotRightTest() {
        ...
        Chariot chariot = new Chariot(Team.CHO, new Position(new Row(7), new Column(3)));
        List<Piece> positioningPiece = List.of(new King(Team.CHO, new Position(new Row(2), new Column(5))));
        Position arrivedPosition = new Position(new Row(7), new Column(8));
        //when
        chariot.move(arrivedPosition, positioningPiece);
        //then
        assertThat(chariot.matchesPosition(new Position(new Row(7), new Column(8)))).isTrue();
    }
