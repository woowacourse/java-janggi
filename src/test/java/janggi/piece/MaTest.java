...
class MaTest {
    ...
    class RouteTest {
        ...
        void checkUpRightRouteMovable() {
            ...
            List<Point> route = ma.findRoute(startPoint, targetPoint);

            assertAll(() -> {
                assertThat(route).hasSize(1);
                assertThat(route).containsExactly(new Point(4, 4));
            });
        }
        ...
        void checkRightLeftRouteMovable() {
            ...
            assertAll(() -> {
                assertThat(route).hasSize(1);
                assertThat(route).containsExactly(new Point(5, 5));
            });
        }
        ...
        void checkDownLeftRouteMovable() {
            ...
            assertAll(() -> {
                assertThat(route).hasSize(1);
                assertThat(route).containsExactly(new Point(6, 4));
            });
        }
        ...
        void checkLeftLeftRouteMovable() {
            ...
            assertAll(() -> {
                assertThat(route).hasSize(1);
                assertThat(route).containsExactly(new Point(5, 3));
            });
        }
