...
class MaTest {
    ...
    void maBoardPosition() {
        ...
        //when
        final Ma ma = new Ma(Team.HAN, position);
    ...
    void nonIsMove(final Position position) {
        //given
        final Ma ma = new Ma(Team.HAN, new Position(5, 5));
    ...
    void hasObstacle() {
        //given
        final Ma ma = new Ma(Team.HAN, new Position(0, 2));

        final Map<Position, Piece> board = Map.of(
                new Position(1, 2), new Cha(Team.HAN, new Position(1, 2))
        );
    ...
    void nonObstacle() {
        ...
        final Map<Position, Piece> board = Map.of(
                new Position(2, 2), new Cha(Team.HAN, new Position(2, 2))
        );
