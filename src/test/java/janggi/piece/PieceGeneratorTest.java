...
public class PieceGeneratorTest {
    ...
    void pieceGeneratorTest(List<Piece> hanPieces, List<Piece> choPieces) {
        ...
        //when
        List<Piece> pieces = new PieceGenerator().generateInitialPieces();
        //then
        assertAll(
    ...
    static Stream<Arguments> makeInitialPieceTestData() {
        return Stream.of(
          Arguments.arguments(
                  ...
                  // 한 - 상마마상
                  List.of(
                          new Chariot(Team.HAN,new Position(new Row(10), new Column(10))), new Chariot(Team.HAN,new Position(new Row(10), new Column(9))),
                          new Cannon(Team.HAN, new Position(new Row(8), new Column(2))), new Cannon(Team.HAN,new Position(new Row(8), new Column(8))),
                          new Elephant(Team.HAN,new Position(new Row(10), new Column(2))), new Elephant(Team.HAN,new Position(new Row(10), new Column(8))),
                          new Horse(Team.HAN,new Position(new Row(10), new Column(3))), new Horse(Team.HAN,new Position(new Row(10), new Column(7))),
                          new Soldier(Team.HAN,new Position(new Row(7), new Column(1))),
                          new Soldier(Team.HAN,new Position(new Row(7), new Column(3))),
                          new Soldier(Team.HAN,new Position(new Row(7), new Column(5))),
                          new Soldier(Team.HAN,new Position(new Row(7), new Column(7))),
                          new Soldier(Team.HAN,new Position(new Row(7), new Column(9))),
                          new Guard(Team.HAN,new Position(new Row(10), new Column(4))), new Guard(Team.HAN,new Position(new Row(10), new Column(6))),
                          new King(Team.HAN,new Position(new Row(9), new Column(5)))
                  )
          )
        );
    }
