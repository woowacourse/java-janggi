...
class GeneralTest {
    ...
    void aa() {
        ...
        Piece piece = PieceCreator.create(Team.GREEN, PieceType.GENERAL);
    ...
    void aaa() {
        ...
        Path path = new Path(List.of(start, goal));
        Piece piece = new General(Team.RED, PieceType.GENERAL);
    ...
    void validateMovable(int startColumn, int startRow, int goalColumn, int goalRow) {
        ...
        Piece piece = new General(Team.GREEN, PieceType.GENERAL);
