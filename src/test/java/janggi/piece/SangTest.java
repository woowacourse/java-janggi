...
//            Point targetPoint = new Point(2, 6);
//
//            Route route = sang.findRoute(targetPoint);
//
//            assertAll(() -> {
//                assertThat(route).isEqualTo(new Route(List.of(
//                        new Point(4, 4), new Point(3, 5), new Point(2, 6)
//                )));
//            });
//        }
//
...
//            assertAll(() -> {
//                assertThat(route).isEqualTo(new Route(List.of(
//                        new Point(5, 5), new Point(4, 6), new Point(3, 7)
//                )));
//            });
//        }
//
...
//            assertAll(() -> {
//                assertThat(route).isEqualTo(new Route(List.of(
//                        new Point(6, 4), new Point(7, 5), new Point(8, 6)
//                )));
//            });
//        }
//
...
//            assertAll(() -> {
//                assertThat(route).isEqualTo(new Route(List.of(
//                        new Point(6, 4), new Point(7, 3), new Point(8, 2)
//                )));
//            });
//        }
//
...
//            assertAll(() -> {
//                assertThat(route).isEqualTo(new Route(List.of(
//                        new Point(5, 3), new Point(4, 2), new Point(3, 1)
//                )));
//            });
//        }
//
...
//            assertAll(() -> {
//                assertThat(route).isEqualTo(new Route(List.of(
//                        new Point(4, 4), new Point(3, 3), new Point(2, 2)
//                )));
//            });
//        }
//    }
