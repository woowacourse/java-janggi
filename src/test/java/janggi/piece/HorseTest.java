...
public class HorseTest {
    ...
    void horseUpRightUpTest() {
        ...
        Position arrivedPosition = new Position(new Row(5), new Column(4));
        //when
        horse.move(arrivedPosition, positioningPiece);
        //then
        assertThat(horse.matchesPosition(new Position(new Row(5), new Column(4)))).isTrue();
    }
    ...
    void horseUpLeftUpTest() {
        ...
        horse.move(arrivedPosition, positioningPiece);
        //then
        assertThat(horse.matchesPosition(new Position(new Row(5), new Column(2)))).isTrue();
    }
    ...
    void horseLeftLeftUpTest() {
        ...
        Horse horse = new Horse(Team.CHO, new Position(new Row(7), new Column(3)));
        List<Piece> positioningPiece = List.of(new King(Team.CHO, new Position(new Row(2), new Column(5))));
        Position arrivedPosition = new Position(new Row(6), new Column(1));
        //when
        horse.move(arrivedPosition, positioningPiece);
        //then
        assertThat(horse.matchesPosition(new Position(new Row(6), new Column(1)))).isTrue();
    }
    ...
    void horseLeftLeftDownTest() {
        ...
        horse.move(arrivedPosition, positioningPiece);
        //then
        assertThat(horse.matchesPosition(new Position(new Row(8), new Column(1)))).isTrue();
    }
    ...
    void horseRightRightUpTest() {
        ...
        Horse horse = new Horse(Team.CHO, new Position(new Row(7), new Column(3)));
        List<Piece> positioningPiece = List.of(new King(Team.CHO, new Position(new Row(2), new Column(5))));
        Position arrivedPosition = new Position(new Row(6), new Column(5));
        //when
        horse.move(arrivedPosition, positioningPiece);
        //then
        assertThat(horse.matchesPosition(new Position(new Row(6), new Column(5)))).isTrue();
    }
    ...
    void horseRightRightDownTest() {
        ...
        horse.move(arrivedPosition, positioningPiece);
        //then
        assertThat(horse.matchesPosition(new Position(new Row(8), new Column(5)))).isTrue();
    }
    ...
    void horseDownRightDownTest() {
        ...
        horse.move(arrivedPosition, positioningPiece);
        //then
        assertThat(horse.matchesPosition(new Position(new Row(9), new Column(4)))).isTrue();
    }
    ...
    void horseDownLeftDownTest() {
        ...
        Horse horse = new Horse(Team.CHO, new Position(new Row(7), new Column(3)));
        List<Piece> positioningPiece = List.of(new King(Team.CHO, new Position(new Row(2), new Column(5))));
        Position arrivedPosition = new Position(new Row(9), new Column(2));
        //when
        horse.move(arrivedPosition, positioningPiece);
        //then
        assertThat(horse.matchesPosition(new Position(new Row(9), new Column(2)))).isTrue();
    }
