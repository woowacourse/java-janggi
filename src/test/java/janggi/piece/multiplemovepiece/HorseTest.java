...
class HorseTest {
    ...
    @DisplayName("마는 팀과 타입을 가진 프로필을 가진다.")
    @Test
    void horsejanggiBoardPosition() {
        ...
        //then
        assertThat(horse.getPieceProfile().getPieceType()).isEqualTo(PieceType.HORSE);
        assertThat(horse.getPieceProfile().getTeam()).isEqualTo(Team.HAN);
    }
