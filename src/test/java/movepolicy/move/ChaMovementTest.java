...
class ChaMovementTest {
    ...
    private final Movement movement = PieceType.CHA.getMovement();
    ...
    @ParameterizedTest
    @EnumSource(Side.class)
    void 앞_1칸_차이인_경우_이동_경로는_존재하지_않는다(final Side side) {
        // given
        Position departure = DEFAULT;
    ...
    @ParameterizedTest
    @EnumSource(Side.class)
    void 뒤_1칸_차이인_경우_이동_경로는_존재하지_않는다(final Side side) {
        // given
        Position departure = DEFAULT;
    ...
    @ParameterizedTest
    @EnumSource(Side.class)
    void 좌_1칸_차이인_경우_이동_경로는_존재하지_않는다(final Side side) {
        // given
        Position departure = DEFAULT;
    ...
    @ParameterizedTest
    @EnumSource(Side.class)
    void 우_1칸_차이인_경우_이동_경로는_존재하지_않는다(final Side side) {
        // given
        Position departure = DEFAULT;
