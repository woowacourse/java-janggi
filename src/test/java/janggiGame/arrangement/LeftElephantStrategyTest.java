...
class LeftElephantStrategyTest {
    @DisplayName("상을 왼쪽으로 배치한다.")
    @Test
    void leftElephantStrategy_Test() {
        LeftElephantStrategy strategy = new LeftElephantStrategy();
        ...
        assertInstanceOf(Horse.class, pieces.get(Position.of(2, 0)));
        assertInstanceOf(Horse.class, pieces.get(Position.of(7, 0)));

        assertInstanceOf(Elephant.class, pieces.get(Position.of(1, 0)));
        assertInstanceOf(Elephant.class, pieces.get(Position.of(6, 0)));
    }
}