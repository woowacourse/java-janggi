...
public class PieceTest {
    ...
    class GoongTest {
        ...
        void test1() {
            // given
            Piece goong = new Piece(Team.HAN, PieceType.궁);
        ...
        void test3() {
            ...
            Piece goong = new Piece(Team.HAN, PieceType.궁);
            Board board = new BoardFixture()
                    .addPiece(4, 1, new Piece(Team.HAN, PieceType.상))
                    .addPiece(5, 1, new Piece(Team.HAN, PieceType.상))
                    .addPiece(6, 1, new Piece(Team.HAN, PieceType.상))
                    .addPiece(4, 2, new Piece(Team.HAN, PieceType.상))
                    .addPiece(6, 2, new Piece(Team.HAN, PieceType.상))
                    .addPiece(4, 3, new Piece(Team.HAN, PieceType.상))
                    .addPiece(5, 3, new Piece(Team.HAN, PieceType.상))
                    .addPiece(6, 3, new Piece(Team.HAN, PieceType.상))
                    .build();
    ...
    class JolTest {
        ...
        void test1() {
            // given
            Piece jol = new Piece(Team.CHO, PieceType.졸);
            Board board = new BoardFixture()
                    .addPiece(5, 5, jol)
                    .build();
        ...
        void test4() {
            ...
            Board board = new BoardFixture()
                    .addPiece(5, 5, jol)
                    .addPiece(4, 5, new Piece(Team.CHO, PieceType.상))
    ...
    class ByeongTest {
        ...
        void test1() {
            // given
            Piece byeong = new Piece(Team.HAN, PieceType.병);
            Board board = new BoardFixture()
                    .addPiece(5, 5, byeong)
                    .build();
        ...
        void test4() {
            ...
            Board board = new BoardFixture()
                    .addPiece(5, 5, byeong)
                    .addPiece(4, 5, new Piece(Team.HAN, PieceType.상))
                    .addPiece(6, 5, new Piece(Team.HAN, PieceType.상))
                    .addPiece(5, 6, new Piece(Team.HAN, PieceType.상))
                    .build();
    ...
    class SaTest {
        ...
        void test1() {
            // given
            Piece sa = new Piece(Team.HAN, PieceType.사);
            Board board = new BoardFixture()
                    .addPiece(5, 2, sa)
                    .build();
        ...
        void test3() {
            // given
            Piece sa = new Piece(Team.CHO, PieceType.사);
            Board board = new BoardFixture()
                    .addPiece(4, 1, new Piece(Team.HAN, PieceType.상))
                    .addPiece(5, 1, new Piece(Team.HAN, PieceType.상))
                    .addPiece(6, 1, new Piece(Team.HAN, PieceType.상))
    ...
    class SangTest {
        ...
        void test1() {
            // given
            Piece sang = new Piece(Team.HAN, PieceType.상);
            Board board = new BoardFixture()
                    .addPiece(5, 5, sang)
                    .build();
    ...
    class MaTest {
        ...
        void test4() {
            // given
            Piece ma = new Piece(Team.CHO, PieceType.마);
            Board board = new BoardFixture()
                    .addPiece(5, 5, ma)
                    .build();
    ...
    class PoTest {
        ...
        void test1() {
            // given
            Piece po = new Piece(Team.HAN, PieceType.포);
            Board board = new BoardFixture()
                    .addPiece(5, 5, po)
                    .addPiece(4, 5, new Piece(Team.HAN, PieceType.마))
                    .addPiece(6, 5, new Piece(Team.HAN, PieceType.마))
                    .addPiece(5, 4, new Piece(Team.HAN, PieceType.마))
        ...
        void test3() {
            ...
            Board board = new BoardFixture()
                    ...
                    .addPiece(7, 5, new Piece(Team.CHO, PieceType.상))
                    .build();
    ...
    class IsSameTeamTest {
        ...
        void test1() {
            // given
            Piece piece1 = new Piece(Team.HAN, PieceType.마);
            Piece piece2 = new Piece(Team.HAN, PieceType.마);
        ...
        void test2() {
            // given
            Piece piece1 = new Piece(Team.HAN, PieceType.마);
            Piece piece2 = new Piece(Team.CHO, PieceType.마);
