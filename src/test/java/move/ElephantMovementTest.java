...
class ElephantMovementTest {
    ...
    void test1() {
        ...
        ElephantMovement elephantMovement = new ElephantMovement();

        //when
        Position result = elephantMovement.move(from, to);
    ...
    void test9() {
        ...
        //when
        //then
        Assertions.assertThatThrownBy(() -> elephantMovement.move(from, to))
