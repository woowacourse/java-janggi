...
public class TestConstant {
    ...
    public static final Position A9 = new Position(Column.A, Row.NINE);
    ...
    public static final Position B9 = new Position(Column.B, Row.NINE);
    ...
    public static final Position C9 = new Position(Column.C, Row.NINE);
    ...
    public static final Position D9 = new Position(Column.D, Row.NINE);
    ...
    public static final Position E9 = new Position(Column.E, Row.NINE);
    ...
    public static final Position F9 = new Position(Column.F, Row.NINE);
    ...
    public static final Position G9 = new Position(Column.G, Row.NINE);
