...
class CrossOneInCastlePathGeneratorTest {

    @Test
    @DisplayName("현재 좌표 기준으로 궁성 내 x축과 y축으로 한 칸씩 이동한 좌표들을 구할 수 있다.")
    void test1() {
        // given
        CrossOneInCastlePathGenerator generator = new CrossOneInCastlePathGenerator();
        Coordinate departure = new Coordinate(5, 2);
