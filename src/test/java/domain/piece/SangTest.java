...
class SangTest {
    ...
    class MaCoordinateTest {
        ...
        @DisplayName("움직이려는 상의 시작 위치가 보드의 밖이면 에러를 반환한다.")
        @Test
        void validateMaFromCoordinate() {
            ...
            assertThatThrownBy(() -> sang.validateMove(board, outOfBoard, inBoard))
                    .isInstanceOf(IllegalArgumentException.class);
        }

        @DisplayName("움직이려는 상의 도착 위치가 보드의 밖이면 에러를 반환한다.")
        @Test
        void validateMaToCoordinate() {
            ...
            assertThatThrownBy(() -> sang.validateMove(board, inBoard, outOfBoard))
                    .isInstanceOf(IllegalArgumentException.class);
        }
