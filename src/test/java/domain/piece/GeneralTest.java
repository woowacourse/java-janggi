...
class GeneralTest {
    ...
    @Test
    void 궁은_궁성_밖으로_이동불가능() {
        Piece general = new General(PieceColor.RED);
        ...
        boolean canMove = general.isValidMovement(movePath);

        assertThat(canMove).isFalse();
    }

    @Test
    void 궁은_궁성_안에서_직선_한칸_이동가능() {
        Piece general = new General(PieceColor.RED);
        Position source = new Position(Row.ONE, Column.FOUR);
    ...
    void 궁은_선이없는_대각방향으로_이동불가능() {
        Piece piece = new General(PieceColor.RED);
