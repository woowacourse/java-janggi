...
class ChariotTest {
    ...
    void 출발점을_기준으로_도착점이_수직_수평_위치에_있지_않다면_에러를_반환한다(int column, int row) {
        ...
        assertThatThrownBy(() -> chariot.validateRule(MoveContextFactory.create(from, to)))
    ...
    void 출발점을_기준으로_도착점이_수직_수평_위치에_있다면_에러를_반환하지_않는다(int column, int row) {
        ...
        assertThatCode(() -> chariot.validateRule(MoveContextFactory.create(from, to)))
    ...
    void 궁성_대각선_방향으로_이동할_수_있다(int column, int row) {
        ...
        assertThatCode(() -> {
            chariot.validateRule(MoveContextFactory.create(from, to));
