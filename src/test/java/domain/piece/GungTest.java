...
class GungTest {
    ...
    class GungCoordinateTest {
        ...
        @DisplayName("움직이려는 궁의 시작 위치가 보드의 밖이면 에러를 반환한다.")
        @Test
        void validateMaFromCoordinate() {
            ...
            assertThatThrownBy(() -> gung.validateMove(board, outOfBoard, inBoard))
                    .isInstanceOf(IllegalArgumentException.class);
        }

        @DisplayName("움직이려는 궁의 도착 위치가 보드의 밖이면 에러를 반환한다.")
        @Test
        void validateMaToCoordinate() {
            ...
            assertThatThrownBy(() -> gung.validateMove(board, inBoard, outOfBoard))
                    .isInstanceOf(IllegalArgumentException.class);
        }

        @DisplayName("내 궁은 내 기물을 잡으려고 할 수 없다.")
        @Test
        void validateTarget() {
            Piece gung = new Gung(Country.HAN);
        ...
        @DisplayName("궁이 현재 위치에서 도달 가능한 위치를 검사한다")
        @Test
