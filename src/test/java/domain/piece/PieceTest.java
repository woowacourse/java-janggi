...
public class PieceTest {
    ...
    class 이동_테스트 {
        ...
        public static Stream<Arguments> providePieceTypeAndNewPositions() {
            return Stream.of(
                    ...
                    Arguments.of(PieceType.병, new Position(라, RANK_5)),
                    Arguments.of(PieceType.병, new Position(바, RANK_5)),
                    Arguments.of(PieceType.병, new Position(마, RANK_4))
            );
        }
    ...
    class 먹기_테스트 {
        ...
        public static Stream<Arguments> providePoNewPositions() {
            return Stream.of(
                    Arguments.of(new Piece(new Position(마, RANK_7), PieceType.포)),
                    Arguments.of(new Piece(new Position(마, RANK_8), PieceType.포)),
                    Arguments.of(new Piece(new Position(다, RANK_5), PieceType.포)),
                    Arguments.of(new Piece(new Position(나, RANK_5), PieceType.포))
            );
        }
        ...
        void 포는_포를_먹을_수_없다(Piece piece) {
            ...
            assertThatThrownBy(() -> piece.move(
                    ...
                    List.of(new Piece(new Position(마, RANK_5), PieceType.포))
            )).isInstanceOf(IllegalArgumentException.class)
                    .hasMessage("움직일 수 없는 위치입니다.");
