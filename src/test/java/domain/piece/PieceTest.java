...
public class PieceTest {
    ...
    @BeforeEach
    void setUp() {
        choPiece = new Piece(Camp.CHO, PieceType.CANNON, PieceType.CANNON.createStrategy());
        hanPiece = new Piece(Camp.HAN, PieceType.CANNON, PieceType.CANNON.createStrategy());
    }
