...
class JolTest {
    ...
    class CanMoveConsideringObstaclesTest {
        ...
        void test1() {
            ...
            // when
            boolean result = jol.canMoveConsideringObstacles(board, new Coordinate(5, 5), new Coordinate(5, 4));
    ...
    class FindPathsTest {
        ...
        void test1() {
            ...
            // when
            final var paths = jol.findPaths(new Coordinate(5, 5), new Coordinate(5, 4));
