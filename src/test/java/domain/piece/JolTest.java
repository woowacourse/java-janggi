...
class JolTest {
    ...
    void 초의_졸은_궁성_대각선_이동_경로_생성에_성공한다(int sourceRow, int sourceColumn, int destinationRow, int destinationColumn) {
        MovablePiece jol = new Jol(Team.CHO);
        Position source = new Position(sourceRow, sourceColumn);
        Position destination = new Position(destinationRow, destinationColumn);

        assertDoesNotThrow(() -> jol.calculatePath(source, destination));
    }

    @ParameterizedTest
    @MethodSource("provideHanPalaceDiagonalPaths")
    void 한의_졸은_궁성_대각선_이동_경로_생성에_성공한다(int sourceRow, int sourceColumn, int destinationRow, int destinationColumn) {
    ...
    void 졸은_궁성_밖에서는_대각선_이동_경로_생성에_실패한다(int sourceRow, int sourceColumn, int destinationRow, int destinationColumn, Team team) {
    ...
    @ParameterizedTest
    @MethodSource("provideChoJolPaths")
    void 초의_졸은_궁성_밖_직선_이동_경로_생성에_성공한다(int sourceRow, int sourceColumn, int destinationRow, int destinationColumn) {
        MovablePiece jol = new Jol(Team.CHO);
        Position source = new Position(sourceRow, sourceColumn);
        Position destination = new Position(destinationRow, destinationColumn);
    ...
    void 초의_졸은_궁성_안_비연결_대각선_이동_경로_생성에_실패한다() {
        MovablePiece jol = new Jol(Team.CHO);
