...
public class JolTest {
    ...
    class ChoTeam {
        ...
        void test2() {
            ...
            // then
            assertThat(movedJol).isEqualTo(new Jol(new Piece(new Coordinate(1, 1), Team.CHO)));
        }
        ...
        void test6() {
            // given
            Jol jol = new Jol(new Piece(new Coordinate(2, 2), Team.CHO));

            // when
            Jol movedJol = jol.moveForward();

            // then
            assertThat(movedJol).isEqualTo(new Jol(new Piece(new Coordinate(2, 1), Team.CHO)));
        }
    }
    ...
    class HanTeam {
        ...
        void test1() {
            // given
            Jol jol = new Jol(new Piece(new Coordinate(2, 1), Team.HAN));

            // when
            Jol movedJol = jol.moveLeft();

            // then
            assertThat(movedJol).isEqualTo(new Jol(new Piece(new Coordinate(3, 1), Team.HAN)));
        }
        ...
        void test3() {
            ...
            // then
            assertThat(movedJol).isEqualTo(new Jol(new Piece(new Coordinate(1, 1), Team.HAN)));
        }
        ...
        void test5() {
            // given
            Jol jol = new Jol(new Piece(new Coordinate(2, 2), Team.HAN));

            // when
            Jol movedJol = jol.moveForward();

            // then
            assertThat(movedJol).isEqualTo(new Jol(new Piece(new Coordinate(2, 3), Team.HAN)));
        }
    }
}
