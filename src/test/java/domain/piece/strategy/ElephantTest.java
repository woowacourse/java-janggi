...
public class ElephantTest {
    ...
    void canMove_이동성공_초_진영_상_기물_움직임_여부_판단() {
        ...
        testBoard.put(Position.of(1, 8), choElephant);

        Position startPosition = Position.of(1, 8);
        Position endPosition = Position.of(4, 6);

        // when, then
        assertThat(choElephant.canMove(testBoard, startPosition, endPosition)).isTrue();
    }
    ...
    void canMove_이동성공_한_진영_상_기물_움직임_여부_판단() {
        ...
        TestBoard testBoard = new TestBoard();
        Piece choElephant = Piece.of(Side.CHO, PieceType.ELEPHANT);
        testBoard.put(Position.of(8, 8), choElephant);
    ...
    void canMove_이동성공_상_기물_움직임_여부_판단_() {
        ...
        TestBoard testBoard = new TestBoard();
        Piece choElephant = Piece.of(Side.CHO, PieceType.ELEPHANT);
        testBoard.put(Position.of(3, 6), choElephant);
    ...
    void 상_움직임_실패_테스트_기물_막힘() {
        ...
        testBoard.put(Position.of(1, 8), choElephant);
        testBoard.put(Position.of(2, 8), hanPawn);

        Position startPosition = Position.of(1, 8);
        Position endPosition = Position.of(4, 6);

        // when, then
        assertThat(choElephant.canMove(testBoard, startPosition, endPosition)).isFalse();
    }
