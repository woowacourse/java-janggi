...
public class ChariotTest {
    ...
    void canMove_이동성공_차_기물_움직임_여부_판단() {
        ...
        testBoard.put(Position.of(1, 9), choChariot);

        Position startPosition = Position.of(1, 9);
        Position endPosition = Position.of(10, 9);

        // when, then
        assertThat(choChariot.canMove(testBoard, startPosition, endPosition)).isTrue();
    }
    ...
    void canMove_이동성공_차_기물_움직임_여부_판단_2() {
        ...
        TestBoard testBoard = new TestBoard();
        Piece choChariot = Piece.of(Side.CHO, PieceType.CHARIOT);
        testBoard.put(Position.of(4, 9), choChariot);
    ...
    void canMove_이동실패_차_기물_움직임_여부_판단() {
        ...
        testBoard.put(Position.of(1, 9), choChariot);
        testBoard.put(Position.of(4, 9), choPawn);

        Position startPosition = Position.of(1, 9);
        Position endPosition = Position.of(10, 9);

        // when, then
        assertThat(choChariot.canMove(testBoard, startPosition, endPosition)).isFalse();
    }
