...
class MaTest {
    ...
    class MaCoordinateTest {
        ...
        void validateTeamTarget() {
            Piece piece = new Ma(Country.HAN);
        ...
        void validateEnemyTarget() {
            ...
            JanggiCoordinate enemyMa = new JanggiCoordinate(7, 4);
        ...
        private static Stream<Arguments> reachableArguments() {
            return Stream.of(
                    Arguments.arguments(new JanggiCoordinate(4, 7)),
                    Arguments.arguments(new JanggiCoordinate(6, 7)),
                    ...
                    Arguments.arguments(new JanggiCoordinate(7, 6))
            );
        }
        ...
        void validateMoveHasObstacle() {
            ...
            assertThatThrownBy(() -> ma.validatePieceMove(board, maCoordinate, moveCoordinate))
                    .isInstanceOf(IllegalArgumentException.class);
        }
        ...
        void validateMoveNoObstacle() {
            ...
            assertDoesNotThrow(() -> ma.validatePieceMove(board, maCoordinate, moveCoordinate));
        }
    }
}
