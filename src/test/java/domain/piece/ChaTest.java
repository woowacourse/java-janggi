...
public class ChaTest {
    ...
    class ChoTeam {
        ...
        @Test
        @DisplayName("CHO 팀의 차가 왼쪽으로 3만큼 움직이면 졸의 x 좌표 3 감소한다.")
        void test2() {
            // given
        ...
        @Test
        @DisplayName("CHO 팀의 차가 오른쪽으로 3만큼 움직이면 졸의 x 좌표가 3 증가한다.")
        void test4() {
            // given
        ...
        @Test
        @DisplayName("CHO 팀의 차가 앞쪽으로 3만큼 움직이면 졸의 y 좌표가 3 감소한다.")
        void test6() {
            // given
        ...
        @Test
        @DisplayName("CHO 팀의 차가 뒤쪽으로 3만큼 움직이면 졸의 y 좌표가 3 증가한다.")
        void test8() {
            // given
            Cha cha = new Cha(new Piece(new Coordinate(2, 5), Team.CHO));
