...
class JanggiTest {
    ...
    void test1() {
        // given
        Unit target = Unit.of(Team.CHO, new ElephantMovingStrategy());
        Position targetPosition = Position.of(4, 5);
        Map<Position, Unit> units = Map.of(
                targetPosition, target,
                Position.of(4, 4), Unit.of(Team.CHO, new SoldierMovingStrategy())
        );
    ...
    void test2() {
        // given
        Unit target = Unit.of(Team.CHO, new HorseMovingStrategy());
        Position targetPosition = Position.of(4, 5);
        Map<Position, Unit> units = Map.of(
                targetPosition, target,
                Position.of(4, 4), Unit.of(Team.CHO, new SoldierMovingStrategy())
    ...
    void test3() {
        // given
        Unit target = Unit.of(Team.CHO, new ChariotMovingStrategy());
        Position targetPosition = Position.of(4, 5);
        Map<Position, Unit> units = Map.of(
                targetPosition, target,
                Position.of(4, 4), Unit.of(Team.CHO, new SoldierMovingStrategy())
    ...
    void test4() {
        // given
        Unit target = Unit.of(Team.CHO, new CannonMovingStrategy());
        Position targetPosition = Position.of(4, 5);
        Map<Position, Unit> units = Map.of(
                targetPosition, target,
                Position.of(4, 4), Unit.of(Team.CHO, new SoldierMovingStrategy())
    ...
    void test5() {
        // given
        Unit target = Unit.of(Team.CHO, new SoldierMovingStrategy());
        Position targetPosition = Position.of(4, 5);
        Map<Position, Unit> units = Map.of(
                targetPosition, target,
                Position.of(4, 4), Unit.of(Team.CHO, new SoldierMovingStrategy())
    ...
    void test7() {
        ...
        Map<Position, Unit> oppositeUnits = Map.of(
                Position.of(4, 4), Unit.of(Team.HAN, new SoldierMovingStrategy())
        );
    ...
    void test8() {
        ...
        Map<Position, Unit> oppositeUnits = Map.of(
                oppositePosition, Unit.of(Team.HAN, new SoldierMovingStrategy())
        );
        Units totalUnits = Units.of(units, oppositeUnits);
        Janggi janggi = Janggi.of(totalUnits, Team.CHO);
    ...
    void test12() {
        ...
        Map<Position, Unit> units = Map.of(
                targetPosition, target,
                Position.of(0, 1), Unit.of(Team.CHO, new SoldierMovingStrategy())
        );
        Unit oppositeCannon = Unit.of(Team.CHO, new CannonMovingStrategy());
