...
class SoldierMoveStrategyTest {
    ...
    void cho_solider_moves_correct_directions() {
        ...
        pieces.put(from, Piece.of(new PieceStatus(SOLDIER, new SoldierMoveStrategy()), Team.CHO));
    ...
    void han_soldier_moves_correct_directions() {
        ...
        pieces.put(from, Piece.of(new PieceStatus(SOLDIER, new SoldierMoveStrategy()), Team.HAN));
