...
public class PalaceOneStepMoveStrategyTest {
    ...
    void can_move_one_step(Position from, Position to) {
        ...
        board.put(from, new General(Side.CHO, generalMoveStrategy, palaceOneStepMoveStrategy));

        //when
        boolean result = palaceOneStepMoveStrategy.canMove(board, from, to, Side.CHO);
    ...
    @Test
    @DisplayName("궁은 궁성에서 대각선으로 적군을 잡을 수 있다")
