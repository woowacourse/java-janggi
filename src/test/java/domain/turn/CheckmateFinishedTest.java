...
class CheckmateFinishedTest {
    ...
    void isFinishedByCheckmateTest() {
        ...
        Finished finished = new CheckmateFinished(board, new TurnState(false, TeamType.HAN));
    ...
    void isFinishedTest() {
        // given
        Board board = new Board(Map.of());
        Turn turn = new CheckmateFinished(board, new TurnState(false, TeamType.HAN));
    ...
    void undoException(boolean undoLast, TeamType teamType) {
        // given
        Board board = new Board(Map.of());
        Turn turn = new CheckmateFinished(board, new TurnState(undoLast, teamType));
    ...
    void undoException() {
        ...
        Turn turn = new CheckmateFinished(board, new TurnState(true, TeamType.HAN));
