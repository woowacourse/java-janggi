...
public final class GuardTest {
    ...
    void test_hasEqualTeam() {
        //given
        final Piece piece = new Guard(new Player(0, Team.CHO));
    ...
    void test_searchRoutePoints() {
        // given
        final Piece guard = new Guard(new Player(0, Team.CHO));
    ...
    void test_isMovableWhenPieceIsInOtherTeamOnRoute() {
        //given
        final Piece guardHan = new Guard(new Player(0, Team.HAN));
        final Piece guardCho = new Guard(new Player(0, Team.CHO));
    ...
    void test_toString() {
        //given
        final Piece pieceForCho = new Guard(new Player(0, Team.CHO));
        final Piece pieceForHan = new Guard(new Player(0, Team.HAN));
