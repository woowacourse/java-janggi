...
class GuardTest {
    ...
    class TestIsAbleToArrive {
        ...
        void test_IsNotAbleToArriveOutOfPalace() {
            ...
            // when
            boolean ableToArrive = guard.isAbleToArrive(startBoardPoint, outOfPalace);
    ...
    class TestGetRoutePoints {
        ...
        void test_GetRoutePoints() {
            ...
            // when
            List<BoardPoint> routePoints = guard.getRoutePoints(startBoardPoint, arrivalPoint);
    ...
    class TestIsMovable {
        ...
        void test_IsNotMovable() {
            ...
            // when
            boolean isMovable = guard.isMovable(new PieceOnRoute(List.of(), new Soldier(Team.HAN)));
        ...
        void test_IsMovable() {
            ...
            // when
            boolean isMovable = guard.isMovable(new PieceOnRoute(List.of(), new Soldier(Team.CHO)));
