...
public final class HorseTest {
    ...
    void test_hasEqualTeam() {
        //given
        final Piece piece = new Horse(TeamType.CHO);
    ...
    void test_isMovableWhenPieceIsInOtherTeamOnRoute() {
        //given
        final Horse horseHan = new Horse(TeamType.HAN);
        final Horse horseCho = new Horse(TeamType.CHO);
    ...
    void test_toString() {
        //given
        final Piece pieceForCho = new Horse(TeamType.CHO);
        final Piece pieceForHan = new Horse(TeamType.HAN);
