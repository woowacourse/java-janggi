...
public final class HorseTest {
    ...
    void test_hasEqualTeam() {
        //given
        final Piece piece = new Horse(new Player(0, Team.CHO));
    ...
    void test_isAbleToArrive() {
        // given
        final Horse horse = new Horse(new Player(0, Team.CHO));
    ...
    void test_isMovableWhenPieceIsInOtherTeamOnRoute() {
        //given
        final Horse horseHan = new Horse(new Player(0, Team.HAN));
        final Horse horseCho = new Horse(new Player(0, Team.CHO));
    ...
    void test_toString() {
        //given
        final Piece pieceForCho = new Horse(new Player(0, Team.CHO));
        final Piece pieceForHan = new Horse(new Player(0, Team.HAN));
