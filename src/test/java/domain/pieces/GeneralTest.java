...
public final class GeneralTest {
    ...
    void test_hasEqualTeam() {
        //given
        final Piece piece = new General(new Player(0, Team.CHO));
    ...
    void test_searchRoutePoints() {
        // given
        final Piece general = new General(new Player(0, Team.CHO));
    ...
    void test_isMovableWhenPieceIsInOtherTeamOnRoute() {
        //given
        final Piece generalHan = new General(new Player(0, Team.HAN));
        final Piece generalCho = new General(new Player(0, Team.CHO));
    ...
    void test_toString() {
        //given
        final Piece pieceForCho = new General(new Player(0, Team.CHO));
        final Piece pieceForHan = new General(new Player(0, Team.HAN));
