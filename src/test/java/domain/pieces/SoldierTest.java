...
public final class SoldierTest {
    ...
    void test_hasEqualTeam() {
        //given
        final Piece piece = new Soldier(TeamType.CHO);
    ...
    class TestAbleToArrive {
        ...
        void test_isAbleToArriveByHan() {
            // given
            final Soldier soldier = new Soldier(TeamType.HAN);
    ...
    void test_isMovableWhenPieceIsInOtherTeamOnRoute() {
        //given
        final Soldier soldierHan = new Soldier(TeamType.HAN);
        final Soldier soldierCho = new Soldier(TeamType.CHO);
    ...
    void test_toString() {
        //given
        final Piece pieceForCho = new Soldier(TeamType.CHO);
        final Piece pieceForHan = new Soldier(TeamType.HAN);
