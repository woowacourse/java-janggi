...
class PalaceRouteGeneratorTest {
    ...
    class 궁과사의_궁성_이동 {
        ...
        void 궁성_중앙에서는_연결된_모든_좌표로_이동_경로를_생성한다() {
            assertThat(palaceRouteGenerator.createPalacePieceRoutes(Position.of(8, 4), TeamColor.CHO))
        ...
        void 궁성_꼭지점에서는_연결된_세_좌표로만_이동_경로를_생성한다() {
            assertThat(palaceRouteGenerator.createPalacePieceRoutes(Position.of(0, 3), TeamColor.HAN))
                    .containsExactlyInAnyOrder(
        ...
        void 궁성_밖의_좌표에서는_이동_경로를_생성하지_않는다() {
            assertThat(palaceRouteGenerator.createPalacePieceRoutes(Position.of(4, 4), TeamColor.HAN))
                    .isEmpty();
        }
    }
    ...
    class 차의_궁성_이동 {
        ...
        void 궁성_중앙에서는_추가_대각선_이동경로만_생성한다() {
            assertThat(palaceRouteGenerator.createRookPalaceRoutes(Position.of(8, 4)))
                    .containsExactlyInAnyOrder(
                            new Route(Position.of(8, 4), Position.of(7, 3), List.of()),
                            new Route(Position.of(8, 4), Position.of(7, 5), List.of()),
                            new Route(Position.of(8, 4), Position.of(9, 3), List.of()),
        ...
        void 궁성_꼭지점에서는_중앙과_반대_꼭지점으로의_추가_대각선_이동경로를_생성한다() {
            assertThat(palaceRouteGenerator.createRookPalaceRoutes(Position.of(0, 3)))
                    .containsExactlyInAnyOrder(
                            new Route(Position.of(0, 3), Position.of(1, 4), List.of()),
        ...
        void 궁성_변의_중간점에서는_추가_대각선_이동경로를_생성하지_않는다() {
            assertThat(palaceRouteGenerator.createRookPalaceRoutes(Position.of(0, 4)))
                    .isEmpty();
        }

        @Test
        void 궁성_밖의_좌표에서는_추가_대각선_이동경로를_생성하지_않는다() {
            assertThat(palaceRouteGenerator.createRookPalaceRoutes(Position.of(4, 4)))
                    .isEmpty();
        }
    }
    ...
    class 포의_궁성_이동 {
        ...
        void 궁성_꼭지점에서는_반대_꼭지점으로의_대각선_이동경로를_생성한다() {
            assertThat(palaceRouteGenerator.createCannonPalaceRoutes(Position.of(0, 3)))
                    .containsExactly(
                            new Route(Position.of(0, 3), Position.of(2, 5), List.of(Position.of(1, 4)))
                    );
        }
        ...
        void 궁성_중앙에서는_추가_대각선_이동경로를_생성하지_않는다() {
            assertThat(palaceRouteGenerator.createCannonPalaceRoutes(Position.of(8, 4)))
                    .isEmpty();
        }

        @Test
        void 궁성_변의_중간점에서는_추가_대각선_이동경로를_생성하지_않는다() {
            assertThat(palaceRouteGenerator.createCannonPalaceRoutes(Position.of(2, 4)))
                    .isEmpty();
        }

        @Test
        void 궁성_밖의_좌표에서는_추가_대각선_이동경로를_생성하지_않는다() {
            assertThat(palaceRouteGenerator.createCannonPalaceRoutes(Position.of(4, 4)))
                    .isEmpty();
        }
    }
    ...
    class 졸의_궁성_이동 {
        ...
        void 초_졸은_궁성_중앙에서_앞쪽_꼭지점으로의_경로를_생성한다() {
            assertThat(palaceRouteGenerator.createPawnPalaceRoutes(Position.of(8, 4), TeamColor.CHO))
                    .containsExactlyInAnyOrder(
                            new Route(Position.of(8, 4), Position.of(7, 3), List.of()),
                            new Route(Position.of(8, 4), Position.of(7, 5), List.of())
                    );
        ...
        void 한_졸은_궁성_중앙에서_앞쪽_꼭지점으로의_경로를_생성한다() {
            assertThat(palaceRouteGenerator.createPawnPalaceRoutes(Position.of(1, 4), TeamColor.HAN))
                    .containsExactlyInAnyOrder(
        ...
        void 초_졸은_센터가_뒤쪽인_앞쪽_꼭지점에서는_센터로_향하지_않는다() {
            assertThat(palaceRouteGenerator.createPawnPalaceRoutes(Position.of(7, 3), TeamColor.CHO))
                    .isEmpty();
        }

        @Test
        void 초_졸은_센터가_앞쪽인_뒤쪽_꼭지점에서는_센터로_향할_수_있다() {
            assertThat(palaceRouteGenerator.createPawnPalaceRoutes(Position.of(9, 3), TeamColor.CHO))
                    .containsExactly(
        ...
        void 한_졸은_센터가_뒤쪽인_뒤쪽_꼭지점에서는_센터로_향하지_않는다() {
            assertThat(palaceRouteGenerator.createPawnPalaceRoutes(Position.of(2, 5), TeamColor.HAN))
                    .isEmpty();
        }

        @Test
        void 한_졸은_센터가_앞쪽인_앞쪽_꼭지점에서는_센터로_향할_수_있다() {
            assertThat(palaceRouteGenerator.createPawnPalaceRoutes(Position.of(0, 5), TeamColor.HAN))
                    .containsExactly(
        ...
        @Test
        void 궁성_변의_중간점에서는_추가_대각선_이동경로를_생성하지_않는다() {
            assertThat(palaceRouteGenerator.createPawnPalaceRoutes(Position.of(9, 4), TeamColor.CHO))
                    .isEmpty();
        }

        @Test
        void 궁성_밖의_좌표에서는_추가_대각선_이동경로를_생성하지_않는다() {
            assertThat(palaceRouteGenerator.createPawnPalaceRoutes(Position.of(4, 4), TeamColor.HAN))
                    .isEmpty();
        }
    }
}
