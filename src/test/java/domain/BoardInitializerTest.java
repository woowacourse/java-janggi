...
class BoardInitializerTest {
    ...
    private static Map<Position, Piece> createPieces(BoardSetting boardSetting) {
        ...
        pieces.put(new Position(1, 0), new Piece(Camp.CHO, horseAndElephantArrangement.get(0)));
        pieces.put(new Position(2, 0), new Piece(Camp.CHO, horseAndElephantArrangement.get(1)));
        pieces.put(new Position(6, 0), new Piece(Camp.CHO, horseAndElephantArrangement.get(2)));
        pieces.put(new Position(7, 0), new Piece(Camp.CHO, horseAndElephantArrangement.get(3)));
        pieces.put(new Position(1, 9), new Piece(Camp.HAN, horseAndElephantArrangement.get(0)));
        pieces.put(new Position(2, 9), new Piece(Camp.HAN, horseAndElephantArrangement.get(1)));
        pieces.put(new Position(6, 9), new Piece(Camp.HAN, horseAndElephantArrangement.get(2)));
        pieces.put(new Position(7, 9), new Piece(Camp.HAN, horseAndElephantArrangement.get(3)));
