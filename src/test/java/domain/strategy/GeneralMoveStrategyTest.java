...
class GeneralMoveStrategyTest {
    ...
    void 궁_목적지에_같은_팀_기물이_있으면_이동_불가() {
        // given
        boardMapper.put(Position.of(1, 5), Piece.of(Team.CHU, Type.SOLIDER, new FixedMoveStrategy()));
        Board board = BoardFactory.of(boardMapper);
    ...
    void 궁_목적지에_다른_팀_기물이_있으면_정상_이동() {
        // given
        boardMapper.put(Position.of(1, 5), Piece.of(Team.HAN, Type.SOLIDER, new FixedMoveStrategy()));
        Board board = BoardFactory.of(boardMapper);
