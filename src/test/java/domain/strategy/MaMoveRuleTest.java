...
class MaMoveRuleTest {
    @ParameterizedTest
    @MethodSource("validMovePositions")
    void 마_이동_가능_좌표_확인_테스트(PieceType pieceType, Position start, Position end) {
    ...
    void 마_이동_불가_좌표_확인_테스트(PieceType pieceType, Position start, Position end) {
        Piece choPiece = new Piece(Country.CHO, pieceType);
        boolean canMove = pieceType.canMovePosition(start, end, choPiece);
