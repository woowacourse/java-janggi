...
public class LeftElephantFormationStrategyTest {
    private final InitializeStrategy strategy = new LeftElephantFormationStrategy();

    @Test
    void 초나라_상마상마_배치가_올바르게_생성된다() {
