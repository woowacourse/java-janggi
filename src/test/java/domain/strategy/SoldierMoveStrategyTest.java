...
class SoldierMoveStrategyTest {
    ...
    void 졸_정상_이동() {
        ...
        // then
        Assertions.assertTrue(soldierPiece.canMovePiece(position, targetPosition, Map.of()));
    }
    ...
    void 졸_목적지에_같은_팀_기물이_있으면_이동_불가() {
        ...
        // then
        Assertions.assertFalse(soldierPiece.canMovePiece(position, targetPosition, Map.of(targetPosition, sameTeamPiece)));
    }
    ...
    void 졸_목적지에_다른_팀_기물이_있으면_정상_이동() {
        ...
        // then
        Assertions.assertTrue(chuSoldierPiece.canMovePiece(position, targetPosition, Map.of(targetPosition, hanSoldierPiece)));
    }
    ...
    void 초나라_졸의_이동_경로가_후퇴이면_이동_불가() {
        ...
        // then
        Assertions.assertFalse(chuSoldierPiece.canMovePiece(position, targetPosition, Map.of()));
    }
    ...
    void 한나라_졸의_이동_경로가_후퇴이면_이동_불가() {
        ...
        // then
        Assertions.assertFalse(hanSoldierPiece.canMovePiece(position, targetPosition, Map.of()));
    }
}
