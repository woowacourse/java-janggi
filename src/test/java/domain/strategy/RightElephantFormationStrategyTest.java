...
public class RightElephantFormationStrategyTest {
    private final InitializeStrategy strategy = new RightElephantFormationStrategy();

    @Test
    void 초나라_마상마상_배치가_올바르게_생성된다() {
