...
class GreenSoldierMoveStrategyTest {
    ...
    void greenSoldier_can_move_test(Position soldierPosition, Position destination) {
    ...
    void greenSoldier_within_palace_corner_can_move_test(Position soldierPosition, Position destination) {
        GreenSoldierMoveStrategy moveStrategy = new GreenSoldierMoveStrategy();
    ...
    void greenSoldier_within_palace_center_can_move_test(Position soldierPosition, Position destination) {
        GreenSoldierMoveStrategy moveStrategy = new GreenSoldierMoveStrategy();
    ...
    void greenSoldier_cannot_move_test(Position soldierPosition, Position wrongTarget) {
        GreenSoldierMoveStrategy moveStrategy = new GreenSoldierMoveStrategy();
    ...
    void greenSoldier_can_move_hasValidPathTo_always_true_test(Position soldierPosition, Position destination) {
        GreenSoldierMoveStrategy moveStrategy = new GreenSoldierMoveStrategy();
