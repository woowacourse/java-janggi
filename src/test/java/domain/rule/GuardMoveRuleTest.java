...
public class GuardMoveRuleTest {
    ...
    void should_move_guard_when_destination_is_empty() {
        ...
        Assertions.assertThatCode(() -> guardMoveRule.validateMoveRule(from, List.of(to)))
                .doesNotThrowAnyException();
    }

    @Test
    @DisplayName("사는 도착지에 상대팀이 있으면 이동할 수 있다.")
    void should_move_guard_when_destination_is_opponent() {
        Point start = new Point(1, 4);
        Point end = new Point(2, 4);
