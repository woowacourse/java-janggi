...
class DirectionTest {
    ...
    void from_좌표에_맞는_올바른_방향을_리턴한다_1() {
        int row = 1;
        int column = 0;
    ...
    void from_좌표에_맞는_올바른_방향을_리턴한다_2() {
        int row = 1;
        int column = 1;
    ...
    void from_좌표에_맞는_올바른_방향을_리턴한다_4() {
        int row = -1;
        int column = 1;
    ...
    void from_좌표에_맞는_올바른_방향을_리턴한다_5() {
        int row = -1;
        int column = 0;
    ...
    void from_좌표에_맞는_올바른_방향을_리턴한다_6() {
        int row = -1;
        int column = -1;
    ...
    void from_좌표에_맞는_올바른_방향을_리턴한다_8() {
        int row = 1;
        int column = -1;
