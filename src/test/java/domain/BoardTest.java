...
public class BoardTest {
    ...
    void test3() {
        // given & when
        Location horseLocation1 = new Location(2, 10);
        Location horseLocation2 = new Location(8,10);
        Location elephantLocation1 = new Location(3,10);
        Location elephantLocation2 = new Location(7,10);
        List<Location> horseLocations = List.of(horseLocation1, horseLocation2);
        List<Location> elephantLocations = List.of(elephantLocation1, elephantLocation2);
        ChoBoard choBoard = ChoBoard.createWithPieces(horseLocations, elephantLocations);
        Map<Location, Piece> choPieces = BoardFixture.createChoPieces(horseLocations, elephantLocations);

        //when
        Map<Location, Piece> pieces = choBoard.getPieces();
    ...
    void test4() {
        ...
        // then
        Piece horsePiece1 = choPieces.get(horseLocation1);
        Piece horsePiece2 = choPieces.get(horseLocation2);
        Piece elephantPiece1 = choPieces.get(elephantLocation1);
        Piece elephantPiece2 = choPieces.get(elephantLocation2);
