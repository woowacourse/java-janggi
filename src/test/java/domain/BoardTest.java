    ...
    class ValidCases {
        ...
        void moveCannonPiece() {
            ...
            Board board = new Board(Map.of(
                ...
                new BoardPosition(0, 4), new Piece(PieceType.JJU, Team.RED))
            );
        ...
        class CanonCases {
            ...
            void movePieceCannonCase1() {
                ...
                Board board = new Board(Map.of(
                    ...
                    new BoardPosition(0, 4), new Piece(PieceType.JJU, Team.RED),
                    new BoardPosition(0, 5), new Piece(PieceType.JJU, Team.GREEN))
                );

                // when & then
                assertThatThrownBy(
                    () -> board.movePiece(new BoardPosition(0, 0), new BoardPosition(0, 6),
                        Team.RED))
                    .isInstanceOf(IllegalArgumentException.class)
