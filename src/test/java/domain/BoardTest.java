...
class BoardTest {
    ...
    void 플레이어의_기물을_이동한다() {
        ...
        Piece expected = new Soldier(1, 5, PieceDirection.HAN_PAWN.get());
    ...
    void 포_이동_경로에_기물이_1개가_아닌_경우_예외가_발생한다() {
        ...
        List<Piece> hanPieces = PieceInit.initHanPieces();
        List<Piece> choPieces = PieceInit.initChoPieces();
        hanPieces.add(new Soldier(5, 3, PieceDirection.HAN_PAWN.get()));
        hanPieces.add(new Soldier(6, 3, PieceDirection.HAN_PAWN.get()));
    ...
    void 포의_목적지에_상대_포가_존재할_경우_예외가_발생한다() {
        ...
        List<Piece> hanPieces = PieceInit.initHanPieces();
        List<Piece> choPieces = PieceInit.initChoPieces();
        hanPieces.add(new Soldier(2, 5, PieceDirection.HAN_PAWN.get()));
    ...
    void 이동한_위치에_존재하는_상대_기물을_삭제한다() {
        ...
        assertAll(() -> {
            ...
            assertThat(choPieces).doesNotContain(new Soldier(1, 7, PieceDirection.CHO_PAWN.get()));
        });
    }
