...
class HanSaTest {
    ...
    void canMoveToValidate(Position position) {
        //given
        HanSa hanSa = new HanSa();
        Position startPosition = new Position(7, 5);

        //when //then
        assertThatThrownBy(() -> hanSa.canMoveTo(startPosition, position))
    ...
    void makeRoute() {
        ...
        HanSa hanSa = new HanSa();
        Position startPosition = new Position(7, 5);
        Position futurePosition = new Position(8, 4);

        //when
        Positions actual = hanSa.makeRoute(startPosition, futurePosition);
    ...
    void pieceTypeTest() {
        ...
        assertThat(hanSa.getPieceType().equals(SA)).isTrue();
    }
    ...
    void isJanggunTest() {
        ...
        assertThat(hanSa.isJanggun()).isFalse();
    }
    ...
    void isNotInPalace() {
        ...
        assertThatThrownBy(() ->
                hanSa.canMoveTo(new Position(7,2), new Position(7,3)))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageStartingWith("[ERROR]");

        assertThatThrownBy(() ->
                hanSa.canMoveTo(new Position(9,3), new Position(9,2)))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageStartingWith("[ERROR]");
    }
