...
class HanJanggunTest {
    ...
    void canMoveToValidate(Position position) {
        //given
        HanJanggun hanJanggun = new HanJanggun();
        Position startPosition = new Position(8, 5);

        //when //then
        assertThatThrownBy(() -> hanJanggun.canMoveTo(startPosition, position))
    ...
    void makeRoute() {
        ...
        Position futurePosition = new Position(8, 5);

        //when
        Positions actual = hanJanggun.makeRoute(startPosition, futurePosition);
    ...
    void pieceTypeTest() {
        ...
        assertThat(hanJanggun.getPieceType().equals(JANGGUN)).isTrue();
    }
    ...
    void isJanggunTest() {
        ...
        assertThat(hanJanggun.isJanggun()).isTrue();
    }
    ...
    void isPoTest() {
        ...
        assertThat(hanJanggun.isPo()).isFalse();
    }
    ...
    void isNotInPalace() {
        ...
        assertThatThrownBy(() ->
                choJanggun.canMoveTo(new Position(7,2), new Position(7,3)))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageStartingWith("[ERROR]");

        assertThatThrownBy(() ->
                choJanggun.canMoveTo(new Position(9,3), new Position(9,2)))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageStartingWith("[ERROR]");
    }
