...
public class PieceDao {
    ...
    public PieceDao(final Connector connector) {
        this.connector = connector;
    }

    public void saveAll(final List<ChessPiece> pieces, final Long roomId) {
        if (pieces == null || pieces.isEmpty()) {
            return;
        }
        String sql = "INSERT INTO piece (y_axis, x_axis, team, piece_type, room_id) VALUES (?, ?, ?, ?, ?)";
