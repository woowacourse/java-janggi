...
public class JanggiBoardGenerator implements BoardGenerator {
    ...
    public Map<Position, Piece> generateBoard() {
        ...
        board.put(new Position(4, 1), new Byeong(Team.HAN));
        board.put(new Position(4, 3), new Byeong(Team.HAN));
        board.put(new Position(4, 5), new Byeong(Team.HAN));
        board.put(new Position(4, 7), new Byeong(Team.HAN));
        board.put(new Position(4, 9), new Byeong(Team.HAN));
        board.put(new Position(7, 1), new Jol(Team.CHO));
        board.put(new Position(7, 3), new Jol(Team.CHO));
        board.put(new Position(7, 5), new Jol(Team.CHO));
        board.put(new Position(7, 7), new Jol(Team.CHO));
        board.put(new Position(7, 9), new Jol(Team.CHO));
