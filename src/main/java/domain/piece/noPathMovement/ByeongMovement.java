...
public class ByeongMovement extends NoPathMovement {

    public ByeongMovement() {
        super(Set.of(MoveVector.DOWN, MoveVector.LEFT, MoveVector.RIGHT));
    }
    ...
    public boolean canMove(
        ...
        movements.removeIf(MoveVector::isUpDirection);
