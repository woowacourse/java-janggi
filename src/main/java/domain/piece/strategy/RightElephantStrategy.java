...
public class RightElephantStrategy implements HorseElephantSetupStrategy{
    private static final List<Piece> HAN_RIGHT_ELEPHANT_HORSE;
    private static final List<Piece> CHO_RIGHT_ELEPHANT_HORSE;

    static {
        CHO_RIGHT_ELEPHANT_HORSE = List.of(
        ...
        HAN_RIGHT_ELEPHANT_HORSE = List.of(
    ...
    public List<Piece> createElephantHorse(TeamType teamType) {
        if (teamType == TeamType.CHO) {
            return new ArrayList<>(CHO_RIGHT_ELEPHANT_HORSE);
        }
        return new ArrayList<>(HAN_RIGHT_ELEPHANT_HORSE);
    }
}
