...
public enum PieceInit {
    ...
    KING(new General(5, 2, PieceDirection.GENERAL.get()), new General(5, 9, PieceDirection.GENERAL.get())),
    ROOK1(new Chariot(1, 1, CHARIOT.get()), new Chariot(1, 10, CHARIOT.get())),
    ROOK2(new Chariot(9, 1, CHARIOT.get()), new Chariot(9, 10, CHARIOT.get())),
    ...
    ADVISOR1(new Guard(4, 1, GUARD.get()), new Guard(4, 10, GUARD.get())),
    ADVISOR2(new Guard(6, 1, GUARD.get()), new Guard(6, 10, GUARD.get())),
    PAWN1(new Soldier(1, 4, HAN_SOLDIER.get()), new Soldier(1, 7, CHO_SOLDIER.get())),
    PAWN2(new Soldier(3, 4, HAN_SOLDIER.get()), new Soldier(3, 7, CHO_SOLDIER.get())),
    PAWN3(new Soldier(5, 4, HAN_SOLDIER.get()), new Soldier(5, 7, CHO_SOLDIER.get())),
    PAWN4(new Soldier(7, 4, HAN_SOLDIER.get()), new Soldier(7, 7, CHO_SOLDIER.get())),
    PAWN5(new Soldier(9, 4, HAN_SOLDIER.get()), new Soldier(9, 7, CHO_SOLDIER.get())),
    ;
