...
public enum PieceInit {
    ...
    CHARIOT1(new Chariot(1, 1, CHARIOT.get()), new Chariot(1, 10, CHARIOT.get())),
    CHARIOT2(new Chariot(9, 1, CHARIOT.get()), new Chariot(9, 10, CHARIOT.get())),
    ...
    GUARD1(new Guard(4, 1, GUARD.get()), new Guard(4, 10, GUARD.get())),
    GUARD2(new Guard(6, 1, GUARD.get()), new Guard(6, 10, GUARD.get())),
