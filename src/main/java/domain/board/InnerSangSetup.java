...
public class InnerSangSetup extends GeneralSangSetup {
    ...
    protected Map<Position, Piece> getSangAndMaPositions(Side side) {
        if (side.isCho()) {
            return Map.of(
                    ...
                    new Position(0, 6), new Sang(Side.CHO),
                    new Position(0, 7), new Ma(Side.CHO)
            );
        }
        return Map.of(
                new Position(9, 1), new Ma(Side.HAN),
                new Position(9, 2), new Sang(Side.HAN),
