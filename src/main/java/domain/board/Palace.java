...
public class Palace {
    ...
    private Map<Position, Set<Direction>> choSidePalaceMap() {
        return Map.of(
                ...
                new Position(8, 6), Set.of(Direction.LEFT_DOWN),
                ...
                new Position(10, 4), Set.of(Direction.RIGHT_TOP),
                new Position(10, 5), Set.of(),
                new Position(10, 6), Set.of(Direction.LEFT_TOP)
        );
    }
    ...
    private Map<Position, Set<Direction>> hanSidePalaceMap() {
        return Map.of(
                ...
                new Position(1, 6), Set.of(Direction.LEFT_DOWN),
                new Position(2, 4), Set.of(),
                new Position(2, 5), Set.of(
                        Direction.RIGHT_TOP, Direction.RIGHT_DOWN, Direction.LEFT_TOP, Direction.LEFT_DOWN),
                new Position(2, 6), Set.of(),
                new Position(3, 4), Set.of(Direction.RIGHT),
                new Position(3, 5), Set.of(),
                new Position(3, 6), Set.of(Direction.LEFT_TOP)
        );
    }
