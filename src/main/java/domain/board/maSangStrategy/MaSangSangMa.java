...
public class MaSangSangMa implements MaSangStrategy {
    ...
    public Map<Coordinate, Piece> createMaAndSang(Team team) {
        ...
        pieces.put(coordinate1, new Ma(team, coordinate1));
        pieces.put(coordinate2, new Sang(team, coordinate2));
        pieces.put(coordinate3, new Sang(team, coordinate3));
        pieces.put(coordinate4, new Ma(team, coordinate4));
        return pieces;
    }
}
