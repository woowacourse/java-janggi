...
public final class JanggiBoardBasicInitializer implements JanggiBoardInitializer {
    ...
    private static void initChoJanggiBoard(final Map<JanggiPosition, JanggiPiece> janggiBoard) {
        ...
        janggiBoard.put(new JanggiPosition(7, 1), new 졸(JanggiSide.CHO));
        janggiBoard.put(new JanggiPosition(7, 3), new 졸(JanggiSide.CHO));
        janggiBoard.put(new JanggiPosition(7, 5), new 졸(JanggiSide.CHO));
        janggiBoard.put(new JanggiPosition(7, 7), new 졸(JanggiSide.CHO));
        janggiBoard.put(new JanggiPosition(7, 9), new 졸(JanggiSide.CHO));
    ...
    private static void initHanJanggiBoard(final Map<JanggiPosition, JanggiPiece> janggiBoard) {
        ...
        janggiBoard.put(new JanggiPosition(4, 1), new 병(JanggiSide.HAN));
        janggiBoard.put(new JanggiPosition(4, 3), new 병(JanggiSide.HAN));
        janggiBoard.put(new JanggiPosition(4, 5), new 병(JanggiSide.HAN));
        janggiBoard.put(new JanggiPosition(4, 7), new 병(JanggiSide.HAN));
        janggiBoard.put(new JanggiPosition(4, 9), new 병(JanggiSide.HAN));
