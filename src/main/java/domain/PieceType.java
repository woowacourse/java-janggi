...
import strategy.move.PalaceStepMoveStrategy;
...
public enum PieceType {
    ...
    GUARD(new PalaceStepMoveStrategy(), "사", MaterialPoints.of(3)),
    HORSE(new HorseMoveStrategy(), "마", MaterialPoints.of(5)),
    KING(new PalaceStepMoveStrategy(), "왕", MaterialPoints.zero()),
