...
public class HanBoard {
    ...
    private Map<Location, ? super Piece> pieces;

    private HanBoard(Map<Location, ? super Piece> pieces) {
        this.pieces = pieces;
    }

    public static HanBoard createWithPieces() {
    ...
    public Map<Location,? super Piece> getPieces() {
        return pieces;
    }
}
