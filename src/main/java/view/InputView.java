...
public class InputView {
    ...
    private static final String INPUT_LOAD_OR_CREATE = "보드를 불러오시겠습니까? 예: y, 아니오: n";
    ...
    public String readLoadOrCreateBoard() {
        System.out.println(LINE_SEPARATOR + INPUT_LOAD_OR_CREATE);
        return scanner.nextLine();
    }

    public String readBoardSelect() {
        System.out.println(LINE_SEPARATOR + INPUT_BOARD_SELECT);
        return scanner.nextLine();
    }
