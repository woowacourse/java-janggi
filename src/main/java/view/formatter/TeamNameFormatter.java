...
public final class TeamNameFormatter {
    ...
    private static final String HAN_TEAM_DISPLAY_NANE = "한";
    private static final String CHO_TEAM_DISPLAY_NANE = "초";

    private static final Map<String, String> DISPLAY_NAME_BY_TEAM = Map.of(
            CHO_TEAM_NAME, CHO_TEAM_DISPLAY_NANE,
            HAN_TEAM_NAME, HAN_TEAM_DISPLAY_NANE
    );
