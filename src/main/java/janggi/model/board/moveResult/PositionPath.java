...
public class PositionPath {
    ...
    private void validateContinuity(Position first, Position last) {
        ...
        int firstRowDistance = Math.abs(nextPosition.getRowDiff(first));
        int firstColumnDistance = Math.abs(nextPosition.getColumnDiff(first));
        ...
        int lastColumnDistance = Math.abs(previousPosition.getColumnDiff(last));
        int lastRowDistance = Math.abs(previousPosition.getRowDiff(last));
