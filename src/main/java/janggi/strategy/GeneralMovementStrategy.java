...
public class GeneralMovementStrategy implements MovementStrategy {

    private final List<Movement> movements;

    public GeneralMovementStrategy() {
    ...
    public boolean canReachGoal(Position start, Position goal) {
        ...
        throw new IllegalArgumentException("[ERROR] 장은 지정한 목적지로 이동할 수 없습니다.");
    }
}
