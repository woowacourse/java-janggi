...
public class SangMaSangMaStrategy extends MaSangArrangementTemplate {

    private static final SangMaSangMaStrategy INSTANCE = new SangMaSangMaStrategy();

    public static SangMaSangMaStrategy getInstance() {
        return INSTANCE;
    }
