...
public class MaSangSangMaStrategy extends MaSangArrangementTemplate {

    private static final MaSangSangMaStrategy INSTANCE = new MaSangSangMaStrategy();

    public static MaSangSangMaStrategy getInstance() {
        return INSTANCE;
    }
