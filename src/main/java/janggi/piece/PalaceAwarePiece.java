...
public abstract class PalaceAwarePiece extends Piece {

    protected PalaceAwarePiece(final PieceType pieceType, final Team team) {
    ...
    public void moveTo(final Position currentPosition, final Position targetPosition,
        ...
        canMoveBy(currentPosition, targetPosition, palace);
