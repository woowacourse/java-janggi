...
public class Elephant implements Piece {
    ...
    private static final List<List<Movement>> movements = List.of(
            List.of(Movement.UP, Movement.RIGHT_UP, Movement.RIGHT_UP),
            List.of(Movement.UP, Movement.LEFT_UP, Movement.LEFT_UP),
            List.of(Movement.LEFT, Movement.LEFT_UP, Movement.LEFT_UP),
            List.of(Movement.LEFT, Movement.LEFT_DOWN, Movement.LEFT_DOWN),
            List.of(Movement.RIGHT, Movement.RIGHT_UP, Movement.RIGHT_UP),
            List.of(Movement.RIGHT, Movement.RIGHT_DOWN, Movement.RIGHT_DOWN),
            List.of(Movement.DOWN, Movement.RIGHT_DOWN, Movement.RIGHT_DOWN),
            List.of(Movement.DOWN, Movement.LEFT_DOWN, Movement.LEFT_DOWN)
    );
