...
public class Palace {
    ...
    public static Palace createHanPalace() {
        Map<Position, List<Direction>> hanCandidates = new HashMap<>() {
            {
        ...
        return new Palace(hanCandidates);
    }

    public static Palace createChoPalace() {
        Map<Position, List<Direction>> choCandidates = new HashMap<>() {
            {
        ...
        return new Palace(choCandidates);
    }
