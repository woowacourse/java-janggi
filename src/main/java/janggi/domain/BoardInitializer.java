...
public class BoardInitializer {
    ...
    private static void initializeHanAttire(Map<Position, Piece> board, int choice) {
        if (choice == 1) {
            board.put(new Position(2, 1), new ElephantPiece(Name.ELEPHANT, Team.HAN));
            board.put(new Position(7, 1), new ElephantPiece(Name.ELEPHANT, Team.HAN));

            board.put(new Position(3, 1), new HorsePiece(Name.HORSE, Team.HAN));
        ...
        if (choice == 2) {
            ...
            board.put(new Position(8, 1), new ElephantPiece(Name.ELEPHANT, Team.HAN));

            board.put(new Position(2, 1), new HorsePiece(Name.HORSE, Team.HAN));
            board.put(new Position(7, 1), new HorsePiece(Name.HORSE, Team.HAN));
        }
        if (choice == 3) {
            board.put(new Position(3, 1), new ElephantPiece(Name.ELEPHANT, Team.HAN));
            board.put(new Position(7, 1), new ElephantPiece(Name.ELEPHANT, Team.HAN));
    ...
    private static void initializeChoAttire(Map<Position, Piece> board, int choice) {
        if (choice == 1) { //상마상마
            ...
            board.put(new Position(8, 10), new ElephantPiece(Name.ELEPHANT, Team.CHO));

            board.put(new Position(2, 10), new HorsePiece(Name.HORSE, Team.CHO));
            board.put(new Position(7, 10), new HorsePiece(Name.HORSE, Team.CHO));
        }

        if (choice == 2) { // 마상마상
            board.put(new Position(2, 10), new ElephantPiece(Name.ELEPHANT, Team.CHO));
            board.put(new Position(7, 10), new ElephantPiece(Name.ELEPHANT, Team.CHO));

            board.put(new Position(3, 10), new HorsePiece(Name.HORSE, Team.CHO));
