...
public class Soldier extends Piece {
    ...
    public Consumer<Map<Position, Piece>> getMovableValidator(final Position beforePosition,
        ...
        return board -> {
            ...
            validateDirectionMovable(beforePosition, afterPosition);
            validatePositionMovable(beforePosition, afterPosition);
        };
    }

    private void validateDirectionMovable(final Position beforePosition, final Position afterPosition) {
    ...
    private void validatePositionMovable(final Position beforePosition, final Position afterPosition) {
