...
public class HorseElephantElephantHorse implements FormationStrategy {
    ...
    public Map<JanggiPosition, Piece> createPieces(Camp camp) {
        return Map.of(
                JanggiPosition.of(camp.baselineRow(), 2), new Elephant(camp, new ElephantStrategy()),
                JanggiPosition.of(camp.baselineRow(), 1), new Horse(camp, new HorseStrategy()),
                JanggiPosition.of(camp.baselineRow(), 6), new Elephant(camp, new ElephantStrategy()),
                JanggiPosition.of(camp.baselineRow(), 7), new Horse(camp, new HorseStrategy())
        );
    }
}
