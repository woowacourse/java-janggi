...
public enum HanBoardSetUp implements BoardSetUp {
    INNER_ELEPHANT(Set.of(
            ...
            new BoardPiece(new HanPoint(1, 8), new Knight(), Dynasty.HAN)
    )),
    OUTER_ELEPHANT(Set.of(
            new BoardPiece(new HanPoint(1, 2), new Elephant(), Dynasty.HAN),
            new BoardPiece(new HanPoint(1, 3), new Knight(), Dynasty.HAN),
            new BoardPiece(new HanPoint(1, 7), new Knight(), Dynasty.HAN),
