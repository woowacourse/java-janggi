...
class Initializer {
    ...
    public Set<Piece> generate() {
        ...
        pieces.add(new Palace(E8.position, Team.HAN));
        pieces.add(new Palace(E1.position, Team.CHO));

        pieces.add(new Soldier(D9.position, Team.HAN));
        pieces.add(new Soldier(F9.position, Team.HAN));
        pieces.add(new Soldier(D0.position, Team.CHO));
        pieces.add(new Soldier(F0.position, Team.CHO));

        pieces.add(new Elephant(C9.position, Team.HAN));
        pieces.add(new Elephant(G9.position, Team.HAN));
        pieces.add(new Elephant(C0.position, Team.CHO));
        pieces.add(new Elephant(G0.position, Team.CHO));

        pieces.add(new Horse(B9.position, Team.HAN));
        pieces.add(new Horse(H9.position, Team.HAN));
        pieces.add(new Horse(B0.position, Team.CHO));
        pieces.add(new Horse(H0.position, Team.CHO));

        pieces.add(new Chariot(A9.position, Team.HAN));
        pieces.add(new Chariot(I9.position, Team.HAN));
        pieces.add(new Chariot(A0.position, Team.CHO));
        pieces.add(new Chariot(I0.position, Team.CHO));

        pieces.add(new Pao(B7.position, Team.HAN));
        pieces.add(new Pao(H7.position, Team.HAN));
        pieces.add(new Pao(B2.position, Team.CHO));
        pieces.add(new Pao(H2.position, Team.CHO));

        pieces.add(new HanPawn(A6.position));
        pieces.add(new HanPawn(C6.position));
        pieces.add(new HanPawn(E6.position));
        pieces.add(new HanPawn(G6.position));
        pieces.add(new HanPawn(I6.position));
        pieces.add(new ChoPawn(A3.position));
        pieces.add(new ChoPawn(C3.position));
        pieces.add(new ChoPawn(E3.position));
        pieces.add(new ChoPawn(G3.position));
        pieces.add(new ChoPawn(I3.position));
