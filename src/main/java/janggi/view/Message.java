...
public class Message {
    ...
    public static final String PLAYER_NAME_NOTICE = "선수(%s) 플레이어의 이름을 입력하세요.";
    public static final String BOARD_SETTING_NOTICE = "장기판의 현황은 다음과 같습니다.";
    public static final String PLAYER_TURN_NOTICE = "(%s) 플레이어 %s 님의 턴입니다. 현재 점수는 %.1f 점입니다.";
    ...
    public static final String GAME_DATA_INFO = "게임 번호 : %d \n초 진영 : %s \n한 진영 : %s \n현재 턴 : %s \n게임 시작 시간 : %s";
}
