...
public class GameManager {
    ...
    public GameManager(Input input, Output output, BoardDao boardDao, TurnDao turnDao) {
        this.input = input;
        this.output = output;
    ...
    private Turn dropPiece(Output output, Input input, Board board, Turn turn, BoardDao boardDao, TurnDao turnDao) {
        try {
    ...
    private void endGame(Output output, Board board, BoardDao boardDao, TurnDao turnDao) {
