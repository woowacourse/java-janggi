...
public abstract class BoardCreateStrategy {
    ...
    private Map<coordinate.Coordinate, Piece> createDefaultBoard(Team team) {
    ...
    private Map<coordinate.Coordinate, Piece> createHanDefaultBoard() {
        return Map.ofEntries(
                Map.entry(new coordinate.Coordinate(1, 1), new Cha(Team.HAN)),
                Map.entry(new coordinate.Coordinate(4, 1), new Sa(Team.HAN)),
                Map.entry(new coordinate.Coordinate(6, 1), new Sa(Team.HAN)),
                Map.entry(new Coordinate(9, 1), new Cha(Team.HAN)),
                Map.entry(new Coordinate(5, 2), new Goong(Team.HAN)),
                Map.entry(new coordinate.Coordinate(2, 3), new Po(Team.HAN)),
    ...
    private Map<coordinate.Coordinate, Piece> createChoDefaultBoard() {
        return Map.ofEntries(
                Map.entry(new Coordinate(1, 10), new Cha(Team.CHO)),
                Map.entry(new coordinate.Coordinate(4, 10), new Sa(Team.CHO)),
                Map.entry(new Coordinate(6, 10), new Sa(Team.CHO)),
                Map.entry(new coordinate.Coordinate(9, 10), new Cha(Team.CHO)),
                Map.entry(new Coordinate(5, 9), new Goong(Team.CHO)),
                Map.entry(new coordinate.Coordinate(2, 8), new Po(Team.CHO)),
                Map.entry(new Coordinate(8, 8), new Po(Team.CHO)),
                Map.entry(new coordinate.Coordinate(1, 7), new Jol(Team.CHO)),
                Map.entry(new Coordinate(3, 7), new Jol(Team.CHO)),
                Map.entry(new coordinate.Coordinate(5, 7), new Jol(Team.CHO)),
                Map.entry(new Coordinate(7, 7), new Jol(Team.CHO)),
                Map.entry(new Coordinate(9, 7), new Jol(Team.CHO))
        );
    }

    protected abstract Map<coordinate.Coordinate, Piece> createPiecesByTeam(Team team);
}
