...
public class BoardInitializer {
    ...
    private void addAllPieces() {
        pieceDao.add(new Chariot(1, Team.GREEN, new Position(1, 10)));
        pieceDao.add(new Chariot(2, Team.GREEN, new Position(9, 10)));
        ...
        pieceDao.add(new Guard(7, Team.GREEN, new Position(4, 10)));
        pieceDao.add(new Guard(8, Team.GREEN, new Position(6, 10)));

        pieceDao.add(new General(9, Team.GREEN, new Position(5, 9)));

        pieceDao.add(new Cannon(10, Team.GREEN, new Position(2, 8)));
        pieceDao.add(new Cannon(11, Team.GREEN, new Position(8, 8)));
        ...
        pieceDao.add(new Chariot(17, Team.RED, new Position(1, 1)));
        pieceDao.add(new Chariot(18, Team.RED, new Position(9, 1)));
        ...
        pieceDao.add(new Guard(23, Team.RED, new Position(4, 1)));
        pieceDao.add(new Guard(24, Team.RED, new Position(6, 1)));

        pieceDao.add(new General(25, Team.RED, new Position(5, 2)));

        pieceDao.add(new Cannon(26, Team.RED, new Position(2, 3)));
        pieceDao.add(new Cannon(27, Team.RED, new Position(8, 3)));
